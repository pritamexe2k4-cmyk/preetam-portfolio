  ...
  return (
    <Shell>
      <main className={`${pageX} pb-24 pt-4`}>
        <SectionTitle kicker="404">Not found</SectionTitle>
        ...
        <div className="mt-10 flex flex-wrap gap-4 font-sans text-lg">
          <Link to="/" className="fill-btn rounded-pill px-6 py-2.5">
            Work
          </Link>
          <Link to="/contact" className="ghost-btn rounded-pill px-6 py-2.5">
            Say Hello
          </Link>
        </div>
      </main>
